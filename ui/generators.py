...
def _get_storage(folder: ContentFolder | None = None):
    """NotionStorageインスタンスを返す。"""
...
def save_titles_to_notion(titles: list[str]) -> dict[str, str]:
...
def save_script_to_notion(title: str, script: str, title_page_ids: dict[str, str]) -> None:
...
def save_slides_to_notion(title: str, slides: list[dict], title_page_ids: dict[str, str]) -> None:
